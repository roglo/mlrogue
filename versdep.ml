...
let ocaml_mktyp loc x = {ptyp_desc = x; ptyp_loc = loc; ptyp_attributes = []}
let ocaml_mkpat loc x = {ppat_desc = x; ppat_loc = loc; ppat_attributes = []}
let ocaml_mkexp loc x = {pexp_desc = x; pexp_loc = loc; pexp_attributes = []}
let ocaml_mkmty loc x = {pmty_desc = x; pmty_loc = loc; pmty_attributes = []}
let ocaml_mkmod loc x = {pmod_desc = x; pmod_loc = loc; pmod_attributes = []}
...
let ocaml_pmty_with mt lcl = let lcl = List.map snd lcl in Pmty_with (mt, lcl)
