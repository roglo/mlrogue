...
let rand_percent = imisc__rand_percent;;
let get_rand = imisc__get_rand;;
let coin_toss = imisc__coin_toss;;

let int_of_object tab x =
  let rec loop_i i =
    if i = vect__vect_length tab then failwith "assert false"
...
let int_of_armor = int_of_object armor_tab;;
...
let potion_tab =
  [| {o_kind = IncreaseStrength; o_title = "of increase strength";
     ...
     {o_kind = Healing; o_title = "of healing"; o_interest = Useful;
      o_value = 100};
     {o_kind = ExtraHealing; o_title = "of extra healing";
      o_interest = Useful; o_value = 200};
     {o_kind = Poison; o_title = "of poison"; o_interest = Harmful;
      o_value = 10};
     {o_kind = RaiseLevel; o_title = "of raise level"; o_interest = Useful;
      o_value = 300};
     {o_kind = Blindness; o_title = "of blindness"; o_interest = Harmful;
      o_value = 10};
     ...
     {o_kind = DetectObjects; o_title = "of detect things";
      o_interest = Useful; o_value = 100};
     {o_kind = Confusion; o_title = "of confusion"; o_interest = Harmful;
      o_value = 10};
     {o_kind = Levitation; o_title = "of levitation"; o_interest = Harmful;
      o_value = 80};
     {o_kind = HasteSelf; o_title = "of haste self"; o_interest = Useful;
      o_value = 150};
     {o_kind = SeeInvisible; o_title = "of see invisible";
      o_interest = Useful; o_value = 145} |]
;;

let int_of_potion = int_of_object potion_tab;;

(* rings *)

let ring_tab =
  [| {o_kind = Stealth; o_title = "of stealth"; o_interest = Useful;
      o_value = 250};
     {o_kind = RTeleport; o_title = "of teleportation"; o_interest = Neutral;
      o_value = 100};
     {o_kind = Regeneration; o_title = "of regeneration"; o_interest = Useful;
      o_value = 255};
     {o_kind = SlowDigest; o_title = "of slow digestion"; o_interest = Useful;
      o_value = 295};
     {o_kind = AddStrength; o_title = "of add strength"; o_interest = Useful;
      o_value = 200};
     {o_kind = SustainStrength; o_title = "of sustain strength";
      o_interest = Useful; o_value = 250};
     {o_kind = Dexterity; o_title = "of dexterity"; o_interest = Useful;
      o_value = 250};
     {o_kind = Adornment; o_title = "of adornment"; o_interest = Neutral;
      o_value = 25};
     ...
     {o_kind = Searching; o_title = "of searching"; o_interest = Useful;
      o_value = 270} |]
;;

let int_of_ring = int_of_object ring_tab;;
...
let scroll_tab =
  [| {o_kind = ProtectArmor; o_title = "of protect armor";
     ...
     {o_kind = HoldMonster; o_title = "of hold monster"; o_interest = Useful;
      o_value = 200};
     {o_kind = EnchantWeapon; o_title = "of enchant weapon";
      o_interest = Useful; o_value = 235};
     {o_kind = EnchantArmor; o_title = "of enchant armor";
      o_interest = Useful; o_value = 235};
     {o_kind = Identify; o_title = "of identify"; o_interest = Useful;
      o_value = 175};
     {o_kind = Teleport; o_title = "of teleportation"; o_interest = Useful;
      o_value = 190};
     {o_kind = Sleep; o_title = "of sleep"; o_interest = Harmful;
      o_value = 25};
     {o_kind = ScareMonster; o_title = "of scare monster";
      o_interest = Useful; o_value = 610};
     {o_kind = RemoveCurse; o_title = "of remove curse"; o_interest = Useful;
      o_value = 210};
...
let int_of_scroll = int_of_object scroll_tab;;
...
let wand_tab =
  [| {o_kind = TeleportAway; o_title = "of teleport away";
     ...
     {o_kind = SlowMonster; o_title = "of slow monster"; o_interest = Useful;
      o_value = 50};
     ...
     {o_kind = Polymorph; o_title = "of polymorph"; o_interest = Neutral;
      o_value = 55};
     {o_kind = HasteMonster; o_title = "of haste monster";
      o_interest = Harmful; o_value = 2};
     {o_kind = PutToSleep; o_title = "of sleep"; o_interest = Useful;
      o_value = 25};
     {o_kind = MagicMissile; o_title = "of magic missile";
      o_interest = Useful; o_value = 20};
     {o_kind = Cancellation; o_title = "of cancellation"; o_interest = Useful;
      o_value = 20};
     {o_kind = DoNothing; o_title = "of do nothing"; o_interest = Neutral;
      o_value = 0} |]
;;

let int_of_wand = int_of_object wand_tab;;

(* weapons *)

let weapon_tab =
  [| {o_kind = Bow; o_title = "short bow"; o_interest = Useful;
      o_value = 150};
     {o_kind = Dart; o_title = "dart/darts"; o_interest = Useful;
      o_value = 8};
     {o_kind = Arrow; o_title = "arrow/arrows"; o_interest = Useful;
      o_value = 15};
     {o_kind = Dagger; o_title = "dagger/daggers"; o_interest = Useful;
      o_value = 27};
     {o_kind = Shuriken; o_title = "shuriken/shurikens"; o_interest = Useful;
      o_value = 35};
     {o_kind = Mace; o_title = "mace"; o_interest = Useful; o_value = 360};
     {o_kind = LongSword; o_title = "long sword"; o_interest = Useful;
      o_value = 470};
     {o_kind = TwoHandedSword; o_title = "two-handed sword";
      o_interest = Useful; o_value = 580} |]
;;

let int_of_weapon = int_of_object weapon_tab;;
...
let create_obj kind q =
  {ob_kind = kind; ob_quantity = q; ob_row = 0; ob_col = 0;
   ob_picked_up = false}
;;

let default_fruit = "slime-mold";;

let get_amulet _ = create_obj Amulet 1;;
...
let gr_wand wk =
  let wk =
    match wk with
      Some wk -> wk
    | None ->
        let k = get_rand 0 (vect__vect_length wand_tab - 1) in wand_tab.(k).o_kind
  in
  let h =
    match wk with
      TeleportAway | SlowMonster | ConfuseMonster | Invisibility | Polymorph |
      HasteMonster | PutToSleep | DoNothing ->
        get_rand 3 6
  ...
  let w =
    let wk =
      match wkind with
        Some wk -> wk
      | None ->
          let k = get_rand 0 (vect__vect_length weapon_tab - 1) in
          weapon_tab.(k).o_kind
    in
    let quiver =
      match wk with
...
let gr_armor ak =
  let ak =
    match ak with
      Some ak -> ak
    | None ->
        let k = get_rand 0 (vect__vect_length armor_tab - 1) in
        armor_tab.(k).o_kind
  in
  let ac =
    match ak with
  ...
  let r =
    let rk =
      match rkind with
        Some rk -> rk
      | None ->
          let k = get_rand 0 (vect__vect_length ring_tab - 1) in
          ring_tab.(k).o_kind
    in
    let (rc, is_cursed) =
      match rk with
      ...
      | AddStrength | Dexterity ->
          let rc =
            let rec loop () =
              let rc = get_rand 0 4 - 2 in if rc = 0 then loop () else rc
            in
            loop ()
          in
          rc, rc < 0
      | Adornment -> 0, coin_toss ()
      | Stealth | Regeneration | SlowDigest | SustainStrength |
        RSeeInvisible | MaintainArmor | Searching ->
          0, false
    in
...
let gr_object g =
  if g.foods < g.cur_level / 2 then
    begin g.foods <- g.foods + 1; get_food None end
  else
