...
type graph == node vect vect
and node = { connection : bool vect; mutable search : search }
...
and drop_scare_state =
  ...
  | DStest_move of int * char vect vect
  | DStest_out_in of move * char vect vect * int
